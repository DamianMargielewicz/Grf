...
void GenerateTextures()
{
	...
	// wczytanie tekstury wood_veneer_walnut_20170214_1045802926.tga
	error = load_targa("wood_veneer_walnut_20170214_1045802926.tga", width, height, format, type, pixels);

	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku wood_veneer_walnut_20170214_1045802926.tga");
		exit(0);
	}
