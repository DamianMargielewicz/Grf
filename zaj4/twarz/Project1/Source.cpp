...
void GenerateTextures()
{
	...
	GLboolean error = load_targa("white_skin_man_face_2.tga", width, height, format, type, pixels);
	...
	// wczytanie tekstury twarz.tga
	error = load_targa("white_skin_man_face_2.tga", width, height, format, type, pixels);
